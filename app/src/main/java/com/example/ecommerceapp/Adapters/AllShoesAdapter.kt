...
import com.example.ecommerceapp.databinding.AllShoesRcViewBinding
import com.example.ecommerceapp.databinding.ShoesRcViewBinding


class AllShoesAdapter(private val shoes: List<ShoesItems>) : RecyclerView.Adapter<AllShoesAdapter.ShoeViewHolder>() {

    // ViewHolder class with binding
    class ShoeViewHolder(val binding: AllShoesRcViewBinding) : RecyclerView.ViewHolder(binding.root)

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ShoeViewHolder {
        val binding = AllShoesRcViewBinding.inflate(LayoutInflater.from(parent.context), parent, false)
